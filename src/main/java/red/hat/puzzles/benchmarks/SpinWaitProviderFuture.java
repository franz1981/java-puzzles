 ...
 */
public class SpinWaitProviderFuture implements AsyncResult {
    ...
    private static final AtomicIntegerFieldUpdater<SpinWaitProviderFuture> COMPLETER_FIELD_UPDATER =
            AtomicIntegerFieldUpdater.newUpdater(SpinWaitProviderFuture.class,"complete");
